...
class ProjectsController extends AbstractController
{
    ...
    #[Route('/', name: 'dashboard_projects_index', methods: ['GET'])]
    ...
    #[Route('/new', name: 'dashboard_new_project', methods: ['GET', 'POST'])]
    public function dashboardNew(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('projects/newDashboard.html.twig', [
            'project' => $project,
            'form' => $form,
        ]);
    ...
    #[Route('/{id}', name: 'dashboard_show_project', methods: ['GET'])]
    public function dashboardShow(Projets $projets): Response
    {
        return $this->render('projects/showDashboard.html.twig', [
            'project' => $projets,
        ]);
    }

    #[Route('/{id}/edit', name: 'dashboard_edit_projects', methods: ['GET', 'POST'])]
    public function dashboardEdit(Request $request, Projets $projets, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('projects/editDashboard.html.twig', [
            'project' => $projets,
            'form' => $form,
        ]);
    }

    #[Route('/{id}/delete', name: 'dashboard_delete_projet', methods: ['POST'])]
    public function dashboardDelete(Request $request, Projets $projets, EntityManagerInterface $entityManager): Response
    {
        if ($this->isCsrfTokenValid('delete'.$projets->getId(), $request->request->get('_token'))) {
...
#[Route('/dashboard/projects/new', name: 'dashboard_new_project', methods: ['GET', 'POST'])]
public function dashboardNew(Request $request, EntityManagerInterface $entityManager): Response
{
    $project = new Projets();
    if(!$project->getDateDeCreation()){
    ...
    if ($form->isSubmitted() && $form->isValid()) {
        ...
        return $this->redirectToRoute('dashboard_projects_index');
    }
...
#[Route('/dashboard/projects/{id}', name: 'dashboard_show_project', methods: ['GET'])]
public function dashboardShow(Projets $projets): Response
{
...
#[Route('/dashboard/projects/{id}/edit', name: 'dashboard_edit_project', methods: ['GET', 'POST'])]
public function dashboardEdit(Request $request, Projets $projets, EntityManagerInterface $entityManager): Response
{
    $form = $this->createForm(ProjectsType::class, $projets);
    $form->handleRequest($request);
...
#[Route('/dashboard/projects/{id}/delete', name: 'dashboard_delete_project', methods: ['POST'])]
public function dashboardDelete(Request $request, Projets $projets, EntityManagerInterface $entityManager): Response
{
    if ($this->isCsrfTokenValid('delete'.$projets->getId(), $request->request->get('_token'))) {
        $entityManager->remove($projets);
