...
class ProjectsController extends AbstractController
{
    ...
    public function dashboardDelete(Request $request, int $id, Projets $project, EntityManagerInterface $entityManager , ProjetsRepository $projetsRepository): Response
    {
        $project = $projetsRepository->find($id);
        if (!$project) {
