...
{
    $projectId = $request->attributes->get('id'); // Utilisation des paramètres de chemin pour récupérer l'ID du projet
    $nfts = $nFTRepository->findBy(['projets' => $projectId]); // Assurez-vous que le nom de la propriété dans NFT correspond au nom dans l'entité Projets
