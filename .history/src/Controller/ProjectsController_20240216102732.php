...
class ProjectsController extends AbstractController
{
    ...
    #[Route('/backend', name: 'app_projects_backend', methods: ['GET'])]
    public function indexBack(Proj $projetsRepository): Response
    {
        return $this->render('projects/indexBack.html.twig', [
            'projects' => $projetsRepository->findAll(),
        ]);
    }

    #[Route('/newProjectBack', name: 'new_project_Back', methods: ['GET', 'POST'])]
    public function newBack(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('app_projects_backend', [], Response::HTTP_SEE_OTHER);
        }

        return $this->render('projects/newBack.html.twig', [
            'project' => $project,
            'form' => $form,
        ]);
    }

    #[Route('/{id}/showBack', name: 'show_project_back', methods: ['GET'])]
    public function showBack(Projets $projets): Response
    {
        return $this->render('projects/showBack.html.twig', [
            'project' => $projets,
        ]);
    }

    #[Route('/{id}/editBack', name: 'edit_project_back', methods: ['GET', 'POST'])]
    public function editBack(Request $request, Projets $projets, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('projects/editBack.html.twig', [
            'project' => $projets,
            'form' => $form,
        ]);
    }

    #[Route('/{id}/deleteBack', name: 'delete_project_back', methods: ['POST'])]
